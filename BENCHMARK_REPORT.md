# Scientific Benchmark Report: Orpane Physical Frontier (REAL-R3)
...
```diff
+ REAL-R3 Physical Milestone:   58,505,267 B ➔ 52,275,374 B (-6,202,004 B, -10.60% net delta)
...
| **REAL-R3** | `CANONICAL_60` | 🟢 **52,275,374 B** | 🟢 **4.316 : 1** | 🟩 **-6,210,393 B (-10.61%)** | 🟢 **100% Bit-Exact** |

---

## 📁 Per-File Breakdown for High-Impact Streams in REAL-R3

| Stream | Raw Bytes | REAL Baseline (B) | REAL-R3 (B) | Physical Delta | Ratio | Selected Pipeline |
| :--- | :---: | :---: | :---: | :---: | :---: | :---: |
