...
> 🕒 **Data Updated**: `2026-09-08 01:56:00 UTC+2` (September 8, 2026)  
...
```diff
+ 🟢 Orpane-MAX (.orpane):  49,849,842 B  [CHAMPION — 100% Win Rate across 53/53 Streams]
...
| :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **Silesia Corpus** | 12 | 211,938,580 B | 48,360,400 B | 🟢 **46,582,901 B** | 🟩 **-1,777,499 B** | 🟩 **-3.68%** | ~1.8 MB/s | **49.8 MB/s** | 699.1 MB | 🏆 **12 / 12 (100%)** |
| **Calgary Corpus** | 18 | 3,251,493 B | 884,474 B | 🟢 **804,909 B** | 🟩 **-79,565 B** | 🟩 **-9.00%** | ~2.4 MB/s | **24.3 MB/s** | 17.4 MB | 🏆 **18 / 18 (100%)** |
| **Canterbury Corpus** | 11 | 2,810,784 B | 493,169 B | 🟢 **418,013 B** | 🟩 **-75,156 B** | 🟩 **-15.24%** | ~3.3 MB/s | **37.9 MB/s** | 8.2 MB | 🏆 **11 / 11 (100%)** |
...
| **GRAND TOTAL** | **53** | **225,159,007 B** | **52,034,935 B** | 🟢 **49,849,842 B** | 🟩 **-2,185,093 B** | 🟩 **-4.20%** | **~2.1 MB/s** | **42.5 MB/s** | **699.1 MB** | 🏆 **53 / 53 (100%)** |
...
| `webster` | 41,458,703 B | 8,370,602 B | 🟢 **8,346,675 B** | 🟩 **-23,927 B** | 4.97:1 | 41.20 s (1.0 MB/s) | 412.0 ms (96.0 MB/s) | 148.9 MB | 🟢 PASS |
...
| :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| `enwik8_real_1MB.raw` | 1,048,576 B | 302,752 B | 293,057 B | 312,661 B | 🟢 **291,788 B** | 🟩 **-10,964 B** (🟩 **-3.62%**) | 3.1 MB/s | 128.2 ms (7.8 MB/s) | 9.0 MB | 🟢 PASS |
...
| `real_c_source_1MB.c` | 1,048,576 B | 172,747 B | 170,218 B | 178,262 B | 🟢 **168,932 B** | 🟩 **-3,815 B** (🟩 **-2.21%**) | 4.4 MB/s | 31.2 ms (32.1 MB/s) | 7.7 MB | 🟢 PASS |
| `source_code_kernel_512KB.c` | 524,288 B | 7,873 B | 8,435 B | 8,674 B | 🟢 **6,431 B** | 🟩 **-1,442 B** (🟩 **-18.32%**) | 3.3 MB/s | 8.1 ms (61.8 MB/s) | 7.2 MB | 🟢 PASS |
| `uniprot_protein_512KB.fasta` | 524,288 B | 233,286 B | 225,506 B | 239,176 B | 🟢 **224,185 B** | 🟩 **-9,101 B** (🟩 **-3.90%**) | 0.5 MB/s | 29.1 ms (17.2 MB/s) | 4.5 MB | 🟢 PASS |
...
| :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| `bib` | 111,261 B | 30,602 B | 🟢 **27,477 B** | 🟩 **-3,125 B** | 4.05:1 | 0.9 MB/s | 3.1 ms (34.4 MB/s) | 7.2 MB | 🟢 PASS |
...
| `news` | 377,109 B | 118,949 B | 🟢 **111,692 B** | 🟩 **-7,257 B** | 3.38:1 | 1.4 MB/s | 33.2 ms (10.8 MB/s) | 8.1 MB | 🟢 PASS |
| `obj1` | 21,504 B | 9,463 B | 🟢 **9,296 B** | 🟩 **-167 B** | 2.31:1 | 0.1 MB/s | 0.2 ms (86.3 MB/s) | 1.4 MB | 🟢 PASS |
| `obj2` | 246,814 B | 61,447 B | 🟢 **61,148 B** | 🟩 **-299 B** | 4.04:1 | 1.3 MB/s | 4.6 ms (50.9 MB/s) | 4.1 MB | 🟢 PASS |
| `paper1` | 53,161 B | 17,331 B | 🟢 **15,469 B** | 🟩 **-1,862 B** | 3.44:1 | 0.3 MB/s | 0.5 ms (112.4 MB/s) | 1.3 MB | 🟢 PASS |
| `paper2` | 82,199 B | 27,321 B | 🟢 **24,863 B** | 🟩 **-2,458 B** | 3.31:1 | 0.4 MB/s | 0.4 ms (190.0 MB/s) | 1.9 MB | 🟢 PASS |
| `paper3` | 46,526 B | 17,132 B | 🟢 **14,651 B** | 🟩 **-2,481 B** | 3.18:1 | 0.3 MB/s | 0.5 ms (84.5 MB/s) | 1.1 MB | 🟢 PASS |
| `paper4` | 13,286 B | 5,469 B | 🟢 **4,294 B** | 🟩 **-1,175 B** | 3.09:1 | 0.1 MB/s | 0.2 ms (52.5 MB/s) | 0.7 MB | 🟢 PASS |
| `paper5` | 11,954 B | 4,956 B | 🟢 **4,084 B** | 🟩 **-872 B** | 2.93:1 | 0.2 MB/s | 0.3 ms (38.7 MB/s) | 0.7 MB | 🟢 PASS |
| `paper6` | 38,105 B | 12,564 B | 🟢 **11,147 B** | 🟩 **-1,417 B** | 3.42:1 | 0.3 MB/s | 0.3 ms (138.0 MB/s) | 1.0 MB | 🟢 PASS |
| `pic` | 513,216 B | 40,060 B | 🟢 **37,033 B** | 🟩 **-3,027 B** | 13.86:1 | 0.7 MB/s | 1.3 ms (366.1 MB/s) | 1.0 MB | 🟢 PASS |
| `progc` | 39,611 B | 12,626 B | 🟢 **11,631 B** | 🟩 **-995 B** | 3.41:1 | 0.2 MB/s | 0.4 ms (96.7 MB/s) | 1.0 MB | 🟢 PASS |
| `progl` | 71,646 B | 14,991 B | 🟢 **14,042 B** | 🟩 **-949 B** | 5.10:1 | 0.4 MB/s | 0.4 ms (193.2 MB/s) | 1.5 MB | 🟢 PASS |
| `progp` | 49,379 B | 10,378 B | 🟢 **9,892 B** | 🟩 **-486 B** | 4.99:1 | 0.3 MB/s | 0.2 ms (195.3 MB/s) | 1.0 MB | 🟢 PASS |
| `trans` | 93,695 B | 16,699 B | 🟢 **15,414 B** | 🟩 **-1,285 B** | 6.08:1 | 0.4 MB/s | 0.4 ms (219.3 MB/s) | 2.1 MB | 🟢 PASS |
...
| `cp.html` | 24,603 B | 7,726 B | 🟢 **6,906 B** | 🟩 **-820 B** | 3.56:1 | 0.2 MB/s | 0.3 ms (89.7 MB/s) | 1.0 MB | 🟢 PASS |
| `fields.c` | 11,150 B | 3,084 B | 🟢 **2,728 B** | 🟩 **-356 B** | 4.09:1 | 0.2 MB/s | 0.2 ms (45.5 MB/s) | 0.4 MB | 🟢 PASS |
| `grammar.lsp` | 3,721 B | 1,364 B | 🟢 **1,135 B** | 🟩 **-229 B** | 3.28:1 | 0.2 MB/s | 0.7 ms (5.1 MB/s) | 0.1 MB | 🟢 PASS |
...
| `sum` | 38,240 B | 9,513 B | 🟢 **9,464 B** | 🟩 **-49 B** | 4.04:1 | 0.3 MB/s | 1.2 ms (30.4 MB/s) | 2.0 MB | 🟢 PASS |
| `xargs.1` | 4,227 B | 1,878 B | 🟢 **1,475 B** | 🟩 **-403 B** | 2.87:1 | 0.1 MB/s | 0.2 ms (20.1 MB/s) | 0.2 MB | 🟢 PASS |
