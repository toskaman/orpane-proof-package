...
* **Orpane-MAX Cumulative Archive Size**: **49,916,161 bytes**
* **7-Zip 26.02 (-mx9) Cumulative Size**: **52,034,935 bytes**
* **Net Space Saved over 7-Zip mx9**: **-2,118,774 bytes (> 2.11 MB)**
...
| Corpus / Suite | Streams | Uncompressed Size | Orpane-MAX Size | 7-Zip 26.02 (mx9) | Net Bytes Saved | Size Reduction (%) | Win Rate vs 7z |
| :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
...
| **Modern Real-World Suite** | 6 | 4,718,592 B | **1,527,937 B** | 1,759,780 B | **-231,843 B** | **-13.17%** | **6 / 6 (100%)** |
| **Private Unseen Holdout** | 6 | 2,439,558 B | **528,479 B** | 537,112 B | **-8,633 B** | **-1.61%** | **6 / 6 (100%)** |
| **GRAND TOTAL** | **53** | **225,159,007 B** | **49,916,161 B** | **52,034,935 B** | **-2,118,774 B** | **-4.07%** | **53 / 53 (100%)** |
...
| `uniprot_protein_512KB.fasta`| Bio/Proteomics | 524,288 B | 233,286 B | 225,506 B | 239,176 B | **224,185 B** | **-9,101 B** | **-3.90%** |
| `astro_sensor_telemetry_512KB.raw`| Float Telemetry | 524,288 B | 309,643 B | 334,113 B | 376,108 B | **194,528 B** | **-115,115 B** | **-37.18%** |
| **TOTAL** | **6 Modern Files** | **4,718,592 B** | **1,759,780 B** | **1,738,702 B** | **1,858,210 B** | **1,527,937 B** | **-231,843 B** | **-13.17%** |
...
| :--- | :---: | :---: | :---: | :---: | :---: |
| **MAX_RATIO** | 37.9 MB/s (70.8 ms) | 24.3 MB/s (127.7 ms) | 49.6 MB/s (4.07 s) | 22.4 MB/s (210.6 ms) | 184.1 MB (Silesia) |
...
## 6. Algorithmic Discoveries Sealed
