...
[![Last Updated](https://img.shields.io/badge/updated-2026--09--16%2014%3A45%20UTC%2B2-blue.svg?logo=clock)](#)
...
| :---: | :---: | :---: | :---: | :---: |
| 🟢 **60 / 60 evaluated** | 🟢 **-2,986,648 B (-5.64%)** | 🟢 **1.34x faster global** | 🟡 **1.58x encode trade-off** | 🟢 **0 errors** |
| Multi-suite evaluation (228.5 MB) | **> 2.9866 MB** net space saved | **88.5 MB/s** (up to 10.6x) | 125.5s vs 79.1s (global) | 100% bit-exact (BLAKE3) |
